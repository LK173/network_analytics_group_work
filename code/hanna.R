                        ...
                        column(3,
                               wellPanel(
                                 ...
                                 tags$p("Disclaimer: Noticable loading times
                                        are possible for displaying the world
                                        map due to a large number of transfers 
                                        in the dataset."),
                      ...
                      fluidPage(
                        ...
                        wellPanel(
                          ...
                          tags$p("The statistical measures of the transfer 
                                 ...
                                 degree, clustering coefficient, average 
                          ...
                          h4(textOutput("transfer_network_interpretation_headline")),
                          p(uiOutput("transfer_network_interpretation"))
                        ),
...
server <- function(input, output, session) {
  ...
  output$world.map.headline <- renderText({
    paste("International Soccer Player Transfers to ", input$country, " in Season", 
          input$season.3.1)
  })
  ...
  output$map <- renderPlotly({
    ...
    p <- p + geom_point(aes(x = dealing_country_lon, y = dealing_country_lat, label = dealing_country), data = season.data_3_1(), color = "green", size = 1)
  ...
  output$transfer_network_interpretation <- renderUI({
